...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Start of any task / onboarding a repo                                                          | Read `docs/KNOWLEDGE_INDEX.md` first as an Orient router (Hierarchy wins on conflict); if `harness-cli knowledge check` reports drift, refresh it via the `generate-knowledge-index` skill before relying on it. |
