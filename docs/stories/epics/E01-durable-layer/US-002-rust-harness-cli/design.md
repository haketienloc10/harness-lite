...
The installer must detect supported platforms and download the matching prebuilt
binary. The installed repository should still expose `scripts/bin/harness-cli`
